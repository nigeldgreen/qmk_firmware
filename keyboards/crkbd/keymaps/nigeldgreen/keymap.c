...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
      ...
      KC_CAPS,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                        KC_H,     KC_J,     KC_K,    KC_L,    KC_SCLN, _COLEMAK,
       _LOREM,  _SFT_Z,    KC_X,    KC_C,    KC_V,    KC_B,                        KC_N,     KC_M,     KC_COMM, KC_DOT,  KC_RSFT, KC_NO,
                                            MO(6), _SYMTAB, _NUMESC,     _FUNENT,  _SYMSPC,  MO(6)
  ),
  [1] = LAYOUT(
  ...
  [4] = LAYOUT(
      KC_TRNS,   KC_NO,   KC_NO,   KC_NO,  KC_NO,    KC_NO,                        KC_LCBR,  KC_7,     KC_8,    KC_9,    KC_RCBR, KC_TRNS,
      KC_TRNS,    _MEH,    _ALT,    _GUI,   _LCTL,   _TMUX,                        KC_LPRN,  KC_4,     KC_5,    KC_6,    KC_RPRN, KC_TRNS,
      KC_TRNS,   KC_NO,   _SALT,   _SGUI,   _SCTL,   KC_NO,                        KC_LBRC,  KC_1,     KC_2,    KC_3,    KC_RCBR, KC_TRNS,
  ...
  [6] = LAYOUT(
      ...
      KC_TRNS,   KC_NO, G(KC_X),   KC_NO,   KC_NO,   KC_NO,                        KC_NO,    G(KC_1),  G(KC_2), G(KC_3), _I3RSCR,   KC_TRNS,
