...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
      ...
      KC_CAPS,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                        KC_H,     KC_J,     KC_K,    KC_L,    KC_SCLN, _COLEMAK,
       _LOREM,  _SFT_Z,    KC_X,    KC_C,    KC_V,    KC_B,                        KC_N,     KC_M,     KC_COMM, KC_DOT,  KC_RSFT, KC_NO,
                                            MO(6),   MO(3),   MO(4),      MO(5),   _SYMSPC,  MO(6)
  ),
  [1] = LAYOUT(
      ...
      KC_TRNS, _SFT_Z,    KC_X,    KC_C,    KC_D,    KC_V,                        KC_K,     KC_H,     KC_COMM, KC_DOT,  KC_RSFT, KC_TRNS,
                                            MO(6),   MO(3),   MO(4),      MO(5),   _SYMSPC,  MO(6)
  ),
  [2] = LAYOUT(
  ...
  [3] = LAYOUT(
      ...
      KC_TRNS,   KC_NO,   _SALT,   _SGUI,   _SCTL,   KC_NO,                        KC_PGDN,  _TILDE,   KC_SLSH, KC_QUES,  KC_NO,  KC_TRNS,
                                            KC_NO, KC_TRNS,   KC_NO,      KC_DEL,  KC_BSPC,  KC_TRNS
  ),
  [4] = LAYOUT(
      KC_TRNS,   KC_NO,   KC_NO,   KC_NO,  KC_NO,    KC_NO,                        KC_NO,    KC_7,     KC_8,    KC_9,    KC_NO,   KC_TRNS,
      KC_TRNS,    _MEH,    _ALT,    _GUI,   _LCTL,   KC_NO,                        KC_NO,    KC_4,     KC_5,    KC_6,    KC_NO,   KC_TRNS,
      KC_TRNS,   KC_NO,   _SALT,   _SGUI,   _SCTL,   KC_NO,                        KC_NO,    KC_1,     KC_2,    KC_3,    KC_NO,   KC_TRNS,
