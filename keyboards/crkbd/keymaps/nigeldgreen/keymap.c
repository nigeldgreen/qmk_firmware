...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT(
      KC_TRNS,   KC_NO,   KC_NO,   KC_NO,  KC_NO,    KC_NO,                        KC_NO,    KC_7,     KC_8,    KC_9,    KC_MINS, KC_TRNS,
      KC_TRNS,    _MEH,    _ALT,    _GUI,   _LCTL, KC_TRNS,                        KC_Z,     KC_4,     KC_5,    KC_6,    COMSPC,  KC_TRNS,
      KC_TRNS, KC_TRNS,   _SALT,   _SGUI,   _SCTL,   KC_NO,                        KC_NO,    KC_1,     KC_2,    KC_3,    KC_NO,   KC_TRNS,
                                            KC_NO,   KC_NO, KC_TRNS,       MO(4),  KC_0,     KC_TRNS
  ),
  [4] = LAYOUT(
