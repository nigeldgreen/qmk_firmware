...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
        ...
        _SFTZ,    KC_X,    KC_C,    KC_V,    KC_B,        KC_N,    KC_M,    KC_COMM, KC_DOT,   KC_RSFT,
                                 _NUMESC, _SYMTAB,        _SYMSPC, _FUNENT
  ),
  [1] = LAYOUT(
  ...
  [2] = LAYOUT(
      ...
      KC_TRNS,   _PIPE, _ATSIGN,  KC_DLR,   KC_NO,        KC_NO,   _SCTL,   _SGUI,   _SALT,    KC_TRNS,
                                   KC_NO,   MO(6),        KC_TRNS, KC_NO
  ),
  [3] = LAYOUT(
        KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,        KC_PGUP, _UNDSCR, KC_MINS, KC_EQL,   KC_HOME,
         _MEH,    _ALT,    _GUI,   _LCTL,  KC_DEL,        KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, KC_SCLN,
      KC_TRNS,   _SALT,   _SGUI,   _SCTL,  KC_ENT,        KC_PGDN, _TILDE,  KC_SLSH, KC_QUES,  KC_END,
                                   KC_NO, KC_TRNS,        KC_BSPC, MO(6)
  ),
  [4] = LAYOUT(
        KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,        KC_NO,  KC_7,     KC_8,    KC_9,     KC_MINS,
         _MEH,    _ALT,    _GUI,   _LCTL,  KC_DEL,        KC_NO,  KC_4,     KC_5,    KC_6,     CMASPC,
      KC_TRNS,   _SALT,   _SGUI,   _SCTL,  KC_ENT,        KC_NO,  KC_1,     KC_2,    KC_3,     KC_PLUS,
                                   KC_TRNS, KC_NO,        KC_0,   KC_DEL
  ),
  [5] = LAYOUT(
