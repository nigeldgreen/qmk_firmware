...
const uint16_t PROGMEM cmb_lcbr[] = {KC_L, KC_U, COMBO_END};
const uint16_t PROGMEM cmb_rcbr[] = {KC_U, KC_Y, COMBO_END};
const uint16_t PROGMEM cmb_cbr[] = {KC_L, KC_U, KC_Y, COMBO_END};
const uint16_t PROGMEM cmb_lprn[] = {KC_N, KC_E, COMBO_END};
const uint16_t PROGMEM cmb_rprn[] = {KC_E, KC_I, COMBO_END};
const uint16_t PROGMEM cmb_prn[] = {KC_N, KC_E, KC_I, COMBO_END};
const uint16_t PROGMEM cmb_lbrc[] = {KC_H, KC_COMM, COMBO_END};
const uint16_t PROGMEM cmb_rbrc[] = {KC_COMM, KC_DOT, COMBO_END};
const uint16_t PROGMEM cmb_brc[] = {KC_H, KC_COMM, KC_DOT, COMBO_END};
const uint16_t PROGMEM cmb_scln[] = {KC_U, KC_E, COMBO_END};
const uint16_t PROGMEM cmb_cln[] = {KC_L, KC_N, COMBO_END};
const uint16_t PROGMEM cmb_squt[] = {KC_M, KC_N, COMBO_END};
const uint16_t PROGMEM cmb_dqut[] = {KC_J, KC_L, COMBO_END};
const uint16_t PROGMEM cmb_caps[] = {KC_K, KC_H, COMBO_END};
combo_t key_combos[] = {
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [6] = LAYOUT(
     S(G(KC_Q)), G(KC_W), G(KC_F), S(G(KC_P)),   KC_NO,     G(KC_0), G(KC_I), G(KC_O), G(KC_9), KC_NO,
     G(KC_Q),      KC_NO,   KC_NO,      KC_NO, G(KC_G),     G(KC_M), G(KC_T), G(KC_N), G(KC_E), KC_NO,
     KC_TRNS,      KC_NO,   KC_NO,    KC_NO, G(KC_TAB),     KC_NO,   G(KC_A), G(KC_R), G(KC_S), KC_NO,
