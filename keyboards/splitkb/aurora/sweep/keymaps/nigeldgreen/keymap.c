...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT(
        DF(0),  KC_SPC, KC_BSPC,  KC_DEL,  KC_ENT,        KC_HOME, UNDSCR, KC_MINS, KC_EQL,   CW_TOGG,
        DF(1),    _ALT,    _GUI,   _LCTL,  TMXPRV,        KC_LEFT, KC_DOWN, KC_UP,  KC_RIGHT, S(KC_SCLN),
      KC_TRNS,   _SALT,   _SGUI,   _SCTL,  TMXNXT,        KC_END,  TILDE,  KC_SLSH, KC_QUES,  KC_NO,
                                 KC_TRNS,   KC_NO,        KC_DEL,  KC_BSPC
  ),
  [4] = LAYOUT(
        KC_F5,   KC_F7,   KC_F8,   KC_F9,  KC_F10,        KC_PGUP, KC_7,     KC_8,    KC_9,     KC_MINS,
         _MEH,    _ALT,    _GUI,   _LCTL,  KC_F12,        KC_NO,   KC_4,     KC_5,    KC_6,     COMSPC,
      KC_TRNS,   _SALT,   _SGUI,   _SCTL,   KC_F2,        KC_PGDN, KC_1,     KC_2,    KC_3,     KC_PLUS,
