...
const uint16_t PROGMEM cmb_z[] = {KC_A, KC_S, COMBO_END};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
      ...
      KC_LSFT,    KC_X,    KC_C,    KC_V,    KC_B,        KC_N,    KC_M,    KC_COMM, KC_DOT,   KC_RSFT,
                       LT(3, KC_TAB), LT(4, KC_ESC),    LT(5, KC_ENT), LT(2, KC_SPC)
  ),
  [1] = LAYOUT(
  ...
  [4] = LAYOUT(
        KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,        KC_NO,  KC_7,     KC_8,    KC_9,     KC_NO,
         _MEH,    _ALT,    _GUI,   _LCTL,   KC_NO,        KC_Z,   KC_4,     KC_5,    KC_6,     KC_NO,
  ...
  [6] = LAYOUT(
      _I3QUIT, _I3TABS, G(KC_E),  _I3RST,  KC_F12,        KC_NO,    G(KC_7),  G(KC_8), G(KC_9), _I3ASCR,
        KC_NO, _I3STCK,   KC_NO, KC_LSFT,   KC_NO,        _I3MV,    G(KC_4),  G(KC_5), G(KC_6),  _I3SCR,
      KC_TRNS, G(KC_X),   KC_NO,   KC_NO,   KC_NO,        KC_NO,    G(KC_1),  G(KC_2), G(KC_3), _I3RSCR,
                                  KC_TRNS,  KC_NO,        KC_TRNS,  G(KC_0)
  )
