...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
     ...
     KC_NO,  _SFT_Z,    KC_X,    KC_C,    KC_V,    KC_B,   _LCTL,   KC_NO,      KC_NO,   _LCTL,   KC_N,     KC_M,     KC_COMM, KC_DOT,  KC_RSFT, KC_NO,
                                 KC_Z,   MO(6), _SYMTAB, _NUMESC, KC_QUOT,     S(KC_2),  _FUNENT, _SYMSPC,  MO(6),    QK_LEAD
  ),
  [1] = LAYOUT(
     KC_NO,    KC_Q,    KC_W,    KC_F,    KC_P,    KC_B,                                          KC_J,     KC_L,     KC_U,    KC_Y,    KC_SCLN, KC_NO,
     KC_NO,    KC_A,    KC_R,    KC_S,    KC_T,    KC_G,                                          KC_M,     KC_N,     KC_E,    KC_I,    KC_O,    KC_NO,
     KC_NO,  _SFT_Z,    KC_X,    KC_C,    KC_D,    KC_V,   _LCTL,   KC_NO,      KC_NO,   _LCTL,   KC_K,     KC_H,     KC_COMM, KC_DOT,  KC_RSFT, KC_NO,
                                 KC_Z,   MO(6), _SYMTAB, _NUMESC, KC_QUOT,     S(KC_2),  _FUNENT, _SYMSPC,  MO(6),    QK_LEAD
  ),
  [2] = LAYOUT(
     ...
     KC_NO, S(KC_3),   _PIPE, _ATSIGN,  KC_DLR,  _LOREM, KC_TRNS, KC_TRNS,      KC_TRNS, KC_TRNS, KC_NO,    _SCTL,    _SGUI,   _SALT,   KC_TRNS, KC_NO,
  ...
  [3] = LAYOUT(
     ...
     KC_NO,   KC_NO,   _SALT,   _SGUI,   _SCTL,   KC_NO, KC_TRNS, KC_TRNS,      KC_TRNS, KC_TRNS, KC_PGDN,  _TILDE,   KC_SLSH, KC_QUES,  KC_NO,  KC_NO,
                              KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,      KC_TRNS, KC_DEL,  KC_BSPC,  KC_TRNS,  KC_TRNS
  ),
  [4] = LAYOUT(
     ...
     KC_NO,   KC_NO,   _SALT,   _SGUI,   _SCTL,   KC_NO, KC_TRNS, KC_TRNS,      KC_TRNS, KC_TRNS, KC_NO,    KC_1,     KC_2,    KC_3,    KC_NO,   KC_NO,
  ...
  [5] = LAYOUT(
     ...
     KC_NO,   KC_NO,   KC_F1,   KC_F2,   KC_F3,  KC_F12, KC_TRNS, KC_TRNS,      KC_TRNS, KC_TRNS, KC_NO,    _SCTL,    _SGUI,   _SALT,   KC_TRNS, KC_NO,
                              KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,      KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS,  KC_TRNS
  ),
  [6] = LAYOUT(
     ...
     KC_NO,   KC_NO, G(KC_X),   KC_NO,   KC_NO,   KC_NO, KC_TRNS, KC_TRNS,      KC_TRNS, KC_TRNS, KC_NO,    G(KC_1),  G(KC_2), G(KC_3), _I3RSCR, KC_NO,
                              KC_TRNS, KC_TRNS, G(KC_TAB), KC_TRNS, KC_TRNS,      KC_TRNS, G(KC_0), G(KC_SPC), KC_TRNS,  KC_TRNS
  )
};
