...
const uint16_t PROGMEM cmb_lent[] = {KC_S, KC_D, KC_F, COMBO_END};
const uint16_t PROGMEM cmb_rent[] = {KC_J, KC_K, KC_L, COMBO_END};
...
combo_t key_combos[COMBO_COUNT] = {
    ...
    COMBO(cmb_lent, KC_ENT),
    COMBO(cmb_rent, KC_ENT),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_SYM1] = LAYOUT(
    ...
    _MEH,      _ALT,      _GUI,     _LCTL,     KC_NO,             KC_QUOT,   MO(_FUN),   S(KC_2), KC_CIRC,  C(KC_6),
    KC_TRNS,  KC_NO,     _SGUI,     _SCTL,     KC_NO,             _TILDE,    KC_SLSH,    KC_BSPC, KC_TRNS,  KC_Z,
                                    KC_NO,   KC_TRNS,             KC_NUBS,   KC_NO
  ),
  [_SYM2] = LAYOUT(
     KC_GRV,  KC_DLR,  KC_PLUS,   KC_NUHS,     KC_NO,             KC_NO,     KC_NO,      KC_NO,   KC_NO,    KC_NO,
    S(KC_3), KC_PERC,  KC_EXLM,   KC_QUES,     KC_NO,             _LCTL,     KC_TRNS,    _GUI,    _ALT,     _MEH,
    KC_TRNS, KC_AMPR,    _PIPE,   _ATSIGN,     KC_NO,             _SCTL,     _SGUI,      KC_NO,   KC_TRNS,  KC_NO,
                                 MO(_NAV),     KC_NO,             KC_NO,     KC_NO
  ),
  [_NUM] = LAYOUT(
      KC_NO,   KC_NO,    KC_NO,     KC_NO,     KC_NO,             KC_LEFT,   KC_7,       KC_8,   KC_9,      KC_RIGHT,
     _MEH,      _ALT,     _GUI,     _LCTL,     KC_NO,             KC_4,      KC_BSPC,    KC_5,   KC_6,      KC_NO,
  ...
  [_NAV] = LAYOUT(
      ...
      _MEH,     _ALT,     _GUI,     _LCTL,     KC_NO,             KC_DOWN,   KC_NO,      KC_UP,   KC_RIGHT, KC_NO,
    KC_TRNS,   KC_NO,    _SGUI,     _SCTL,     KC_NO,             KC_END,    KC_NO,      KC_NO,   KC_TRNS,  KC_LEFT,
                                  KC_TRNS,     KC_NO,             KC_NO,     KC_PGDN
  ),
  [_FUN] = LAYOUT(
      KC_NO,   KC_F7,    KC_F8,     KC_F9,    KC_F10,             DF(_QWER), DF(_CMAK),  KC_NO,   KC_NO,    KC_NO,
    _KTYCFG,   KC_F4,    KC_F5,     KC_F6,    KC_F11,             _LCTL,     KC_TRNS,    _GUI,    _ALT,     _MEH,
    _KTYRST,   KC_F1,    KC_F2,     KC_F3,    KC_F12,             _SCTL,     _SGUI,      KC_NO,   KC_TRNS,  KC_NO,
                                  _REBOOT,     KC_NO,             KC_NO,     KC_NO
  ),
};
