...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWER] = LAYOUT(
    ...
    KC_Z,      KC_X,      KC_C,     KC_V,       KC_B,              KC_M,      KC_COMM,    KC_SPC,  KC_NO,  KC_H,
                                MO(_NUM),  MO(_SYM1),              KC_DOT,    KC_N
  ),
  [_CMAK] = LAYOUT(
    KC_Q,      KC_W,      KC_F,      KC_P,      KC_B,              KC_J,      KC_L,       KC_U,    KC_Y,     KC_SCLN,
    KC_A,      KC_R,      KC_S,      KC_T,      KC_G,              KC_N,      MO(_SYM2),  KC_E,    KC_I,     KC_O,
    KC_Z,      KC_X,      KC_C,      KC_D,      KC_V,              KC_H,      KC_COMM,    KC_SPC,  KC_NO,    KC_M,
  ...
  [_SYM1] = LAYOUT(
    ...
    KC_NO,    KC_NO,     KC_NO,     KC_NO,     KC_NO,              _TILDE,    KC_SLSH,    KC_BSPC, KC_NO,    KC_NO,
  ...
  [_NUM] = LAYOUT(
    ...
    KC_TRNS,   KC_NO,    KC_NO,     KC_NO,    KC_DEL,             KC_1,       KC_2,       KC_0,    KC_NO,    KC_NO,
